...
class PostData:
    ...
    def get_cost(self) -> float:
        type_cost_map = {
            BasicPostages.REGULAR_CARD : .20,
            BasicPostages.LARGE_CARD : .37,
            BasicPostages.REGULAR_ENVELOPE : .37,
            BasicPostages.LARGE_ENVELOPE : .60,
            SpecialPostages.PACKAGE : 2.95,
            SpecialPostages.LARGE_PACKAGE : 3.95,
        }
        
        zone_cost_map = {
            BasicPostages.REGULAR_CARD : .03,
            BasicPostages.LARGE_CARD : .03,
            BasicPostages.REGULAR_ENVELOPE : .04,
            BasicPostages.LARGE_ENVELOPE : .05,
            SpecialPostages.PACKAGE : .25,
            SpecialPostages.LARGE_PACKAGE : .35,
        }
...
class BasicPostages(Postages):
    REGULAR_CARD = Postage(Size(3.5, 4.25), Size(3.5, 6), Size(.007, .016))
    LARGE_CARD =  Postage(Size(4.25, 6), Size(6, 11.5), Size(.007, .015))
    REGULAR_ENVELOPE = Postage(Size(3.5, 6.125), Size(5, 11.5), Size(.16, .25))
    LARGE_ENVELOPE = Postage(Size(6.125, 24), Size(11, 18), Size(.25, .5))
